...
public class PhotoGalleryFragment extends Fragment {
    ...
    private List<GalleryItem> mItems = new
            ArrayList<>();

    private ThumbnailDownloader<PhotoHolder>
        ...
        mThumbnailDownloader.setThumbnailDownloadListener(
                new
                        ThumbnailDownloader.ThumbnailDownloadListener<PhotoHolder>
                            ...
                            @Override
                            public void
                            onThumbnailDownloaded(PhotoHolder photoHolder,
                                                  Bitmap
                                                          bitmap) {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View v =
                inflater.inflate(R.layout.fragment_photo_gallery,
                        container, false);
        ...
        public void onBindViewHolder(PhotoHolder
           ...
           // photoHolder.bindGalleryItem(galleryItem);
            Drawable placeholder =
                    getResources().getDrawable(R.drawable.bill_up_close);
